...
int main(void)
{
  ...
  console_puts(shell_config_version());
...
// System configurable syslog string prefix.
const char *syslog_config_prefix(void)
{
  return "bootloader: ";
}
...
{
  return network_str_to_address("192.168.1.100");
}
